...
trump_df = pd.read_csv('./input/twitter_airline.csv')
...
def cleaner(tmpL):
    ...
    tmpL  = remove_emoticons(tmpL)
    tmpL  = remove_emoji(tmpL)
...
trump_df.to_csv('./input/twitter_airline_1.csv') #specify location
